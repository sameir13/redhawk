...
const Page = () => {
  ...
  return (
    <div>
      <BreadCrumb Head={"Inventory Management"} />
      <section className="">
        <div className=" grid grid-cols-1 md:grid-cols-2 gap-5 place-items-center  max-w-[1100px] py-[110px] px-5 mx-auto">
          <div>
            ...
            <p className=" text-lg font-normal">
              Red Hawk provides advanced inventory management services that
              enhance the accuracy and security of stock monitoring. By
              integrating with platforms to predict demand and optimize stock
              levels, we also enhance security to prevent theft and unauthorized
              access, effectively safeguarding your inventory. Our inventory
              management represents a shift towards more secure, accurate, and
              data-driven operations, enabling businesses to maintain a
              competitive edge in the marketplace.
            </p>
          </div>
          <div className="relative ">
            <img src="/images/service-2.jpeg" className="w-full rounded-3xl" alt="" />
            <div className=" -bottom-20 right-0 absolute z-10 bg-white  shadow-2xl   w-32 h-32 rounded-full flex items-center justify-center ">
              <i class="bx bx-package text-5xl text-indigo-400"></i>
            </div>
          </div>
        </div>
