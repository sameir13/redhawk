...
const Page = () => {
  ...
  return (
    <div>
      <BreadCrumb Head={"Incident Management"} />
      <section className="">
        <div className=" grid grid-cols-1 md:grid-cols-2 gap-5 place-items-center  max-w-[1100px] py-[110px] px-5 mx-auto">
          <div>
            ...
            <p className=" text-lg font-normal">
              Red Hawk specializes in incident management under various
              contexts. We continuously observe premises, enabling security
              personnel to detect incidents as they occur and respond promptly.
              In the case of an incident, CCTV footage provides crucial evidence
              that can be used for investigations and legal proceedings. We
              deter potential offenders from engaging in unlawful behavior,
              thereby reducing the likelihood of incidents.
            </p>
          </div>
          <div className="relative ">
            ...
            <div className=" -bottom-20 right-0 absolute z-10 bg-white  shadow-2xl   w-32 h-32 rounded-full flex items-center justify-center ">
              <i class="bx bx-alarm-exclamation text-5xl text-indigo-400"></i>
            </div>
          </div>
        </div>
