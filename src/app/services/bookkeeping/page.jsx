        ...
        <div className=" grid grid-cols-1 md:grid-cols-2 gap-5 place-items-center  max-w-[1100px] py-[110px] px-5 mx-auto">
          <div>
            ...
            <p className=" text-lg font-normal">
              Red Hawk brings access to specialized expertise and enhanced
              accuracy in financial management. We employ seasoned professionals
              adept in accounting practices, tax laws, and compliance
              requirements, ensuring meticulous record-keeping.Moreover, We
              offer valuable financial insights, providing regular reports that
              aid in informed decision-making and cash flow tracking. Red Hawk
              is dedicated to ensuring the confidentiality and security of
              financial data by employing robust systems to protect sensitive
              information.
            </p>
          </div>
          <div className="relative ">
            ...
            <div className=" -bottom-20 right-0 absolute z-10 bg-white  shadow-2xl   w-32 h-32 rounded-full flex items-center justify-center ">
              <i class="bx bx-edit text-5xl text-indigo-400"></i>
            </div>
          </div>
        </div>
