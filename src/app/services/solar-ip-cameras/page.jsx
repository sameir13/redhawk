...
const Page = () => {
  ...
  return (
    <div>
      <BreadCrumb Head={"Solar IP Cameras"} />
      <section className="">
        <div className=" grid grid-cols-1 md:grid-cols-2 gap-5 place-items-center  max-w-[1100px] py-[110px] px-5 mx-auto">
          <div>
            ...
            <p className=" text-lg font-normal">
              Red Hawk offers state-of-the-art solar IP cameras, providing
              reliable and exceptional surveillance solutions. Our solar-powered
              cameras ensure continuous monitoring with minimal environmental
              impact, making them ideal for remote or off-grid locations. These
              cameras combine high-resolution video, advanced motion detection,
              and easy installation, delivering top-notch security without the
              need for traditional power sources.
            </p>
          </div>
